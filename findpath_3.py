...
path = 'G:\竞赛学术\双智竞赛\智慧城市竞赛\成果\论文数据/区域七_分支点4_三次扩充'
time_cost = 0
cost2 = 0
...
if __name__ == "__main__":
    ...
    y = list(0 for i in range(int(a)+3))
    z = []
    ...
    # 使用遗传算法求解目标函数的最小值
    # 构造遗传算法对象 ex_GA
    ex_GA = sko.GA.GA(func=findallway, n_dim=(int(a)+3), size_pop=6, max_iter=100, prob_mut=0.6,
